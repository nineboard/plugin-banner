...
namespace Xpressengine\Plugins\Banner\Commands;

final class SkinMake extends \App\Console\Commands\SkinMake
{
    use RegisterArtisan;
     ...
     * @var string
     */
    protected $signature = 'make:banner-widget-skin
